...
const LaboratoriosReconhecidos = () => {
  const laboratorios = {
    A: [
      { codigo: "407.01", nome: "A+FF Soluções Ambientais Ltda", cidade: "Uberaba/MG" },
      { codigo: "371.01", nome: "A+FF Soluções Ambientais", cidade: "São Lourenço/MG" },
      { codigo: "383.01", nome: "AFP Ambiental", cidade: "Carmo/MG" },
      { codigo: "439.01", nome: "AMBIENSYS ANÁLISES AMBIENTAIS E SÃO ALIMENTOS LTDA", cidade: "Maringá/MG" },
      { codigo: "", nome: "Laboratório Ambiensys", cidade: "" }
    ],
    B: [],
    C: [
      ...
      { codigo: "530.01", nome: "Laboratório de Análise Ambiental e Pesquisa Mineral", cidade: "Belo Horizonte/MG" },
      { codigo: "346.02", nome: "Companhia de Saneamento Municipal", cidade: "Juiz de Fora/MG" },
    ...
    E: [
      ...
      { codigo: "", nome: "Laboratório de Ensaios Diversos", cidade: "" }
    ],
    F: [],
    G: [
      { codigo: "359.01", nome: "GMG SOLUÇÕES AMBIENTAIS EIRELI", cidade: "Belo Horizonte/MG" },
    ...
    M: [
      ...
      { codigo: "", nome: "Laboratório Gc Six Consultoria", cidade: "" },
    ...
    T: [
      ...
      { codigo: "372.01", nome: "TKS Soluções", cidade: "Betim/MG" },
      { codigo: "", nome: "TKS Meio Ambiente", cidade: "" }
    ],
    U: [
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-4xl mx-auto mb-8">
              A lista de Reconhecimento de Laboratórios em Processo apresentada aqui não tem validade de Declaração de Laboratórios em Processo de Reconhecimento de Competência.
            </p>
            <p className="text-muted-foreground max-w-4xl mx-auto">
              Regulamenta também que, a não Declaração não deve para o laboratório no período descrito na lista de serviços reconhecidos, apresentadas na área Laboratórios Reconhecidos.
            </p>
            <p className="text-muted-foreground max-w-4xl mx-auto mt-4">
              Consulte as normas internas ao processo em: <span className="text-primary underline">https://www.rmmg.com.br</span>
            </p>
          </div>
            ...
            {Object.entries(laboratorios).map(([letra, labs]) => (
              <div key={letra}>
                ...
                {labs.length > 0 ? (
                  ...
                  <p className="text-muted-foreground italic">Nenhum laboratório reconhecido nesta seção.</p>
                )}
              </div>
            ))}
          </div>
...
export default LaboratoriosReconhecidos;